  ...
  <body v-show="visible">
    <div class="container-fluid">
      <div class="row">
                ...
                >
                  ...
                  >
                    ...
                    <line
                      ...
                      y2="14"
                    ></line>
                    <circle v-if="item[1] == 6" cx="12" cy="12" r="10"></circle>
                    <line
                      v-if="item[1] == 6"
                      x1="12"
                      y1="12"
        ...
        <SystemServiceDash :visible="service_visible" />
      </div>
    </div>
  </body>
</template>
...
import SystemServiceDash from '@/components/ui/SystemService.vue'
